...
/* harmony import */ var _vendor_lazysizes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/lazysizes */ "./js/vendor/lazysizes.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var btnClose = document.querySelector('[data-validate="btn-close"]');
  var btnOpen = document.querySelector('[data-validate="btn-open"]');
  var nav = document.querySelector('[data-validate="nav"]');
  var wrapper = document.querySelector('[data-validate="wrapper"]');
  var logo = document.querySelector('[data-validate="logo"]');
  var navLink = document.querySelectorAll('[data-validate="nav-link"]');
  ...
  var overlay = document.querySelector('[data-validate="overlay"]');
  var body = document.querySelector('body');
  var isEscapeKey = function isEscapeKey(key) {
    return key === 'Escape';
  };
  var focus = new _utils_focus_lock__WEBPACK_IMPORTED_MODULE_3__["FocusLock"]();
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_vendor_lazysizes__WEBPACK_IMPORTED_MODULE_2__["lazySizes"])();
  });
});
